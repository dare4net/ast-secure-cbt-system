    ...
    <AuthLayout requireAuth allowedRoles={["student"]}>
      ...
      <div className="flex items-center justify-between">
        ...
        <Button asChild className="rounded-full">
          <Link href="/students/exams">Browse Exams</Link>
        </Button>
      </div>
      ...
      <Card className="border-border/50">
        ...
        <CardContent className="grid gap-3 sm:grid-cols-3">
          <Button asChild variant="outline" className="rounded-full">
            <Link href="/students/exams">Browse All Exams</Link>
          </Button>
          <Button asChild variant="outline" className="rounded-full">
            <Link href="/students/results">View All Results</Link>
          </Button>
          <Button asChild variant="outline" className="rounded-full">
            <Link href="/students/dashboard">Download Certificate</Link>
          </Button>
        </CardContent>
      </Card>
    </div>
